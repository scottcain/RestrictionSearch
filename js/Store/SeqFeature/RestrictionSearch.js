define("RestrictionSearch/Store/SeqFeature/RestrictionSearch", [
        'dojo/_base/declare',
        'dojo/_base/array',
        'dojo/_base/lang',
    ...
    return declare( SeqFeatureStore , {
        ...
        doSearch: function( query, sequence, params, featCallback ) {
            console.log(params.ecor1);
            var expr = new RegExp(
                params.ecor1 ? 'gaattc' : params.regex ? params.expr : this.escapeString( params.expr ),
                'gi'  //was params.caseIgnore ? "gi" : "g"
            );
