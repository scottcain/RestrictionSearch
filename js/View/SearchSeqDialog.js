define("RestrictionSearch/View/SearchSeqDialog", [
        'dojo/_base/declare',
        'dojo/dom-construct',
        'dojo/aspect',
        'dijit/focus',
...
return declare( ActionBarDialog, {
    ...
    _dialogContent: function () {
        ...
        content.caseIgnore = new dCheckBox({ label: "EcoR1",
                                               id: "search_ecor1",
                                               checked: true
                                            });
        caseDiv.appendChild( content.ecor1.domNode );
        dom.create( "label", { "for": "search_ecor1", innerHTML: "EcoR1"}, caseDiv );
